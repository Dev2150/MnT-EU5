...
def _create_default_config():
	...
	try:
		...
		config['Paths'] = {
			...
			'unit_types': DEFAULT_LOG_PATH,
			'building_types': DEFAULT_LOG_PATH,
		}
...
def get_from_config(section, option):
	...
	try:
		...
		print(f"WARNING: Config file at '{CONFIG_FILE}' is missing the required {section} section or {option} key. Using default path.")
		return DEFAULT_LOG_PATH
	except Exception as e:
